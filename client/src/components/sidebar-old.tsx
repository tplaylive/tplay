import { Tv, Newspaper, Trophy, Film, Music, Baby, GraduationCap, Cross, Play, Upload, Plus } from "lucide-react";
            ...
            return (
              <li key={category.id}>
                <button
                  ...
                  className={`flex items-center space-x-3 p-3 rounded-xl w-full text-left transition-all ${
                    isSelected
